            ...
            <div className="space-y-6 text-gray-700">
              <section>
                ...
                <p>
                  ...
                  tu dispositivo cuando visitas nuestra plataforma. Nos ayudan a
                  mejorar tu experiencia y a entender cómo utilizas Babelink.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p>
                      Son necesarias para el funcionamiento básico de la
                      plataforma, como mantener tu sesión activa y recordar tus
                      preferencias de idioma.
                    </p>
                  </div>

                  <div>
                    <h3 className="text-[#333366] mb-2">
                      Cookies de Rendimiento
                    </h3>
                    <p>
                      Nos ayudan a entender cómo los usuarios interactúan con la
                      plataforma, qué páginas visitan más y si encuentran
                      errores.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Permiten recordar tus elecciones (como tu nombre de
                      usuario, idioma o región) para proporcionarte una
              ...
              <section>
                ...
                <p className="mb-2">
                  También utilizamos cookies de terceros para:
                </p>
              ...
              <section>
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    ...
                    dispositivo durante un período específico o hasta que las
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    Configurando tu navegador para rechazar todas las cookies
                  </li>
                  <li>
                    Configurando tu navegador para aceptar solo cookies de
                    sitios específicos
                  </li>
                  <li>
                    Eliminando todas las cookies cuando cierres tu navegador
                  </li>
                  <li>Utilizando nuestro panel de preferencias de cookies</li>
                </ul>
                <p className="mt-3">
                  <strong>Nota:</strong> Deshabilitar las cookies puede afectar
              ...
              <section>
                ...
                <p>
                  ...
                  legales. Te recomendamos revisarla regularmente.
                </p>
              </section>
