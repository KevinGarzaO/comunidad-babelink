        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto">
              Cursos prácticos, talleres y recursos para potenciar tu
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-lg text-gray-700 mb-6">
                        6 meses de aprendizaje intensivo para dominar la
                        creación de contenido con IA, construir tu marca
                        personal y lanzar tu proyecto al mundo.
                      </p>
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="border-2 border-gray-200 hover:border-[#333366] transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl text-[#333366] mb-2">SEO con IA</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Aprende a posicionar tu contenido usando herramientas de
              ...
              <Card className="border-2 border-gray-200 hover:border-[#333366] transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Crea videos profesionales y automatiza tu producción
                    audiovisual
                  </p>
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    <Clock className="h-4 w-4" />
              ...
              <Card className="border-2 border-gray-200 hover:border-[#333366] transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Automatiza tu presencia en redes sociales con inteligencia
                    artificial
                  </p>
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    <Clock className="h-4 w-4" />
            ...
            <Card className="bg-gradient-to-br from-[#333366] to-[#5a5a8a] text-white border-0 shadow-2xl">
              <CardContent className="p-12">
                ...
                <p className="text-xl text-gray-200 mb-8">
                  Únete al Programa de Creadores y comienza tu camino hacia la
                  excelencia en contenido digital
                </p>
                <Button
                  size="lg"
                  onClick={() => router.push("/creadores")}
